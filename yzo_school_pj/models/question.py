...
class SchoolQuestion(models.Model):
    _name="school.question"
    _description="Exam Questions"
    _rec_name="major_id"

    major_id=fields.Many2one('school.major',string="Subject") # for major name
    question_ids=fields.One2many('question.line','question_id',string="Questions") # for questions
...
class QuestionLine(models.Model):
    ...
    question_id=fields.Many2one('school.question') # for inverse name to link One2many
